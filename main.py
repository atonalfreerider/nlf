...
def main(video_path: str, output_dir: str):
    ...
    while start_frame < total_frames:
        ...
        try:
            ...
            # Store 3D poses with frame numbers
            joints3d = __convert_tensor_to_list(pred['joints3d'])
            #joints2d = __convert_tensor_to_list(pred['joints2d'])
            #boxes = __convert_tensor_to_list(pred['boxes'])
            ...
            for frame_idx, frame_path in enumerate(frame_paths):
                ...
                frame_poses_3d = joints3d[frame_idx]
                #frame_poses_2d = joints2d[frame_idx]
                #frame_boxes = boxes[frame_idx]
                #frame_betas = betas[frame_idx]

                # Store each pose for this frame
